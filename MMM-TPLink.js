 ...
 * @license MIT
 *
 * @see https://github.com/slametps/MMM-TPLink
 */
Module.register("MMM-TPLink", {
    ...
    getStyles: function () {
        return ["font-awesome.css", "MMM-TPLink.css"];
    },
...
/*        if (self.devices) {
          ...
          s = '';
          function myFunc(item, idx) {
            s += idx + '-' + item.alias + '-' + item.on_off + ',';
          }
          self.devices.forEach(myFunc);
          wrapper.innerHTML = s;
        }
        else {
    ...
    getData: function () {
      this.notificationReceived('TPLINK_NETWORK_SEARCH');
    },
    ...
    socketNotificationReceived: function(notification, payload) {
      ...
      if (notification == 'TPLINK_NETWORK_SEARCH_RESULT') {
